    ...
    while(True):
        ...
        try: 
            ...
            if(timeSeriesChoice == 1):
                url = f'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol={stockSymbol}&interval=5min&apikey=9XOMX3XJU9HQH6LD'
                break
            elif(timeSeriesChoice == 2):
                url = f'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol={stockSymbol}&apikey=9XOMX3XJU9HQH6LD'
                break
            elif(timeSeriesChoice == 3):
                url = f'https://www.alphavantage.co/query?function=TIME_SERIES_WEEKLY&symbol={stockSymbol}&apikey=9XOMX3XJU9HQH6LD'
                break
            elif(timeSeriesChoice == 4):
                url = f'https://www.alphavantage.co/query?function=TIME_SERIES_WEEKLY_ADJUSTED&symbol={stockSymbol}&apikey=9XOMX3XJU9HQH6LD'
                break
            else:
